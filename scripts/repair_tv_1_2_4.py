...
# Eliminar cualquier versión anterior antes de insertar exactamente una.
...
# Eliminar todas las versiones históricas y colocar una sola antes de stateMap.
...
TARGET.write_text(s)
print('OK: receptor TV reconstruido sin duplicados; Dashboard intacto')
