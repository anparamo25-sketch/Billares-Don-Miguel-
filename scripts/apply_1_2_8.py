...
# Escape dollar signs because tvHtml is emitted as a Dart double-quoted string.
html_for_dart = html.replace('C$', r'C\$')
tv_dart = '  String get tvHtml => ' + json.dumps(html_for_dart, ensure_ascii=False) + ';'
