...
class _DashboardPageState extends State<DashboardPage>
  ...
  Future<void> finishGame(BillTable table) async {
    ...
    setState(() {
      ...
      table.amount = table.liveAmount.roundToDouble();
  ...
  Future<bool> configureThermalPrinter() async {
    ...
    try {
      ...
      final BluetoothInfo selected = printers.firstWhere(
        (BluetoothInfo p) => p.macAdress == selectedMac,
      );
  ...
  Future<String?> printReceipt(BillTable table) async {
    ...
    try {
      // print_bluetooth_thermal 1.2.4 gestiona el permiso Bluetooth de Android 12+
      ...
      if (savedMac == null || savedMac.isEmpty)
        return 'Configura primero la impresora térmica desde Configuración.';
      ...
      if (printer == null)
        return 'La impresora guardada ya no está emparejada. Ve a Configuración → Impresora térmica.';
              ...
              children: <Widget>[
                ...
                ...items.map(
                  (HistoryEntry e) => ListTile(
                    ...
                    title: Text('Mesa ${e.table} • ${totalMoney(e.amount)}'),
                    subtitle: Text(
